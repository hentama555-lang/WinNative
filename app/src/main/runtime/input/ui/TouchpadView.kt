...
class TouchpadView(
    ...
    private fun updateXform(outerWidth: Int, outerHeight: Int, innerWidth: Int, innerHeight: Int) {
        ...
        // Keep the fullscreen path compatible with VulkanRenderer's explicit fullscreen draw
        // path. All non-fullscreen modes use the exact inverse of ViewTransformation.
        ...
        if (vt.mode == ViewTransformation.FILL_MODE_STRETCH) {
            ...
            // Important: offset must be divided by the same scale as the coordinates.
            // Building T then S with XForm.multiply scales the translation too and was the
            // source of the visible/input alignment drift.
            val invScale = 1.0f / vt.aspect
            XForm.set(
                xform,
                invScale,
                0f,
